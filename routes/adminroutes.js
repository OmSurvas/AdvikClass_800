...
router.get("/login_page",checkLogin,function(req,res){
...
router.get("/admin_profile",checkLogin,async function(req,res){
...
router.get("/about_home",checkLogin,async  function(req,res){
...
router.get("/gallery_slider",checkLogin,async function(req,res){
...
router.get("/add_contact",checkLogin,async function(req,res){
...
router.get("/company_information",checkLogin,async function(req,res){
...
router.get("/add_Our_mission_&_vision",checkLogin,async function(req,res){
...
router.get("/add_faq",checkLogin,async function(req,res){
...
router.get("/edit_faq/:faq_id",checkLogin,async function(req,res) 
{
...
router.get("/add_testimonials",checkLogin,async function(req,res){
...
router.get("/edit_testimonial/:testimonial_id",checkLogin,async function(req,res) 
{
...
router.get("/add_about_founder",checkLogin,async function(req,res){
...
router.get("/add_why_choose_us",checkLogin,async function(req,res){
...
router.get("/add_Toppers",checkLogin,async function(req,res){
...
router.get("/edit_topper/:topper_id",checkLogin,async function(req,res){
...
router.get("/gallry_categary",checkLogin,async function(req,res){
...
router.get("/gallry",checkLogin,async function(req,res){
    var data=await exe('SELECT * FROM categories');
...
router.get("/update_gallry_edit/:id",checkLogin,async function(req,res){
    var id=req.params.id;
...
router.get("/result_categary",checkLogin,async function(req,res){
...
router.get("/edit_result_category/:id",checkLogin,async function(req,res){
    var id=req.params.id;
...
router.get("/result",checkLogin,async function(req,res){
    var data=await exe('SELECT * FROM result_category');
...
router.get("/update_result_edit/:id",checkLogin,async function(req,res){
   var id=req.params.id;
...
router.get("/rankes",checkLogin,async function(req,res){
...
router.get("/subject_topper",checkLogin,async function(req,res){
...
router.get("/update_blog_edit/:id",checkLogin,async function(req,res){
    var id=req.params.id;
...
router.get("/latest_blog",checkLogin,async function(req,res){
...
router.get("/latest_blog_update/:id",checkLogin,async function(req,res){
   var id=req.params.id;
...
router.get("/research_blog",checkLogin,async function(req,res){
...
router.get("/awesome_features",checkLogin,async function(req,res){
...
router.get("/popular_courses",checkLogin,async function(req,res){
...
router.get("/edit_popular_course/:popular_course_id",checkLogin,async function(req,res) 
{
...
router.get("/counts",checkLogin,async function(req,res){
...
router.get("/course_page",checkLogin,async function(req,res){
...
router.get("/course_update/:id",checkLogin,async function(req,res){
    var id=req.params.id;
...
router.get("/course",checkLogin,async function(req,res){
    var data=await exe(`SELECT * FROM course_category `);
...
router.get("/update_couse_edit/:id",checkLogin,async function(req,res){
    var id=req.params.id;
...
router.get("/level_category",checkLogin,async function(req,res){
...
router.get("/level_category/:id",checkLogin,async function(req,res){
    var id=req.params.id;
...
router.get("/level",checkLogin,async function(req,res){
    var data=await exe(`SELECT * FROM level_category`);
...
router.get("/level_update/:id",checkLogin,async function(req,res){
    var id=req.params.id;
